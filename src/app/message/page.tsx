            ...
            {!isNotSolved && (
                <div className={styles["pass-div"]}>
                    <div className={styles.note + " " + styles.scrollable}>
                        ...
                        <p>The NYT games has been a big part of our relationship. Whether we&apos;re both in the same country or on different continents I always woke up knowing I was going to get a message of your wordle attempt. Thank you for giving me that kind of consistency and thank you for allowing me to share these games with you. </p>
                        <p>Beyond that thank you for being such a good sister. I hope the effort I put into this shows just how much you mean to me. In my eyes you deserve a billion times more than this but for now I hope this will do. I also hope you enjoyed them :{')'}</p>
                        <p>You're the glue to this family, and the one we go to for advice (as shown in the connections). You embody the title of big sister and though not easy, you do it almost perfectly. I hope you&apos;re aware of how much the family loves you because there really is no one like you. From your wacky remedies (strands) to your hilarious sayings (wordle) just know we appreciate everything about you.</p>
